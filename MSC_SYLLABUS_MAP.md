...
| W2 | Vector, matrix, tensor ops; NumPy | **Green/Amber** | Completed 2025 JHU linear algebra foundation + Repo 10–17 + 27 + Lesson 31 scaling/axis/tensor conversion; 17 Sep pairwise vectorisation practice + live float32 VRAM calculation | Deepen dtype representation (signed integers; floating sign/exponent/mantissa), strides/contiguity, lecturer-specific slicing/indexing and singleton-axis insertion before interpolation |
